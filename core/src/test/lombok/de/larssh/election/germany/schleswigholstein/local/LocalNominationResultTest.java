...
class LocalNominationResultTest {
	...
	void testSainteLagueRethwisch() {
		...
		// @formatter:off
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Beck", "Karsten")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(24036, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Behnk", "Sönke")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(88133, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Bernhardt", "Christian")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(12590, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Breede", "Rolf")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(20486, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Böttger", "Johannes")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(31480, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Böttger", "Volker")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(157400, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Dohrendorf", "Martina")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(13916, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Dohrendorf", "Thomas")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(9560, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Efrom", "Joachim")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(8435, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Eggers", "Dirk")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(52880, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Ehlert", "Armin")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(11429, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Eick", "Ernst")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(26667, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Feddern", "Axel")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(7547, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Feddern", "Hartmut")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(6829, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Gräpel", "Carola")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(20338, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Gäde", "Henning")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(17489, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Gäde", "Jan-Hendrik")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(52467, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Hartz", "Catrin")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(11031, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Jögimar", "Helga")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(16000, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Klein", "Erik")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(15553, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Kraus", "Michael")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(28680, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Kröger", "Dirk")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(80000, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "König", "Eva-Maria")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(13036, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Kühn", "Steffen")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(143400, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Motzkus", "Dietrich")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(37771, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Poppinga", "Jens")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(264400, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Sauer", "Joachim")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(7273, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Schwarz", "Rupert")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(17627, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Schöning", "Mathias")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(15933, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Stapelfeldt", "Albert")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(14309, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Topel", "Andreas")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(11496, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Wahl", "Joachim")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(47800, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Weger", "Marcel")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(29378, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Winter", "Martin")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(22486, 2));
		assertThat(nominationResults.get(LocalElectionTest.findNomination(election, "Ziebarth", "Angelika")).getSainteLagueValue().get()).isEqualTo(BigDecimal.valueOf(8889, 2));
		// @formatter:on
	}
